 ...
 * Date: 2018/10/11
 */
package com.adam.app.demoset.lockscreen.legacy;
...
import com.adam.app.demoset.lockscreen.MyAdminReceiver;
...
//    public static final int REQUEST_SECURE_LOCK_CODE = 0x0112;
     ...
     */
    private void buildItemStrategyList() {
...
//        deprecate startActivityForResult(intent, REQUEST_ENABLE_ADMIN_CODE);
    ...
    private void showAuthentication() {
        ...
        // deprecate this.startActivityForResult(intent, REQUEST_SECURE_LOCK_CODE);
